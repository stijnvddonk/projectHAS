...
public class QueryBuilder {
	...
	public String setDeviceData(int deviceID) {
		if (this.debug) DataLogger.systemLog("QueryBuilder: setDeviceData\n");
	...
	public ResultSet DevicesTypeID(String deviceName) {
		if (debug) DataLogger.systemLog("QueryBuilder: DevicesTypeID\n");
	...
	public ResultSet Users() {
		...
		if (this.debug) DataLogger.systemLog(query);
		return dbm.execute(query);
	}
	...
	public ResultSet getTopIP() {
		if (debug) DataLogger.systemLog("QueryBuilder: getTopIP\n");
	...
	public Integer addNewDevice(String deviceName, String IPAdres, int typeID, String MACAdres) {
		if (this.debug) DataLogger.systemLog("QueryBuilder: insertNewDevice\n");
	...
	public ResultSet DevicesEnabledStatus(String deviceName) {
		if (debug) DataLogger.systemLog("QueryBuilder: DevicesEnabledStatus\n");
	...
	public void enableDisableDevice(int id, String deviceName) {
		if (this.debug) DataLogger.systemLog("QueryBuilder: disableDevice\n");
	...
	public ResultSet getStartEndTime(String deviceName) {
		if (debug) DataLogger.systemLog("QueryBuilder: getStartEndTime\n");
	...
	public ResultSet DevicesTimerStatus(String deviceName) {
		if (debug) DataLogger.systemLog("QueryBuilder: DevicesTimerStatus\n");
	...
	public void enableDisableTimerDevice(int id, String deviceName) {
		if (debug) DataLogger.systemLog("QueryBuilder: enableDisableTimerDevice\n");
		// Creating a query to disable a device
	...
	public void deleteDevice(String deviceName) {
		if (this.debug) DataLogger.systemLog("QueryBuilder: deleteDevice\n");
	...
	public ResultSet getDeviceTypes() {
		if (debug) DataLogger.systemLog("QueryBuilder: getDeviceTypes\n");
	...
	public void updateLogin(Integer userid, Timestamp currentTimeStamp) {
		if (debug) DataLogger.systemLog("QueryBuilder: updateLogin\n");
